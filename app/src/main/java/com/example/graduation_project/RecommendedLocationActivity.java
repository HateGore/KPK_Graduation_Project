...
public class RecommendedLocationActivity extends AppCompatActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recommended_location);


        Intent intent = getIntent();
        latitude = Double.parseDouble(intent.getStringExtra("mapx"));
        longitude = Double.parseDouble(intent.getStringExtra("mapy"));
...
//            System.out.println("onStop : mGoogleApiClient disconnect");
    ...
    public void setRecommendLocation() {
        mMoveMapByUser = false;


        //디폴트 위치, Seoul
        LatLng Recommended_LOCATION = new LatLng(longitude, latitude);
        ...
        markerOptions.position(Recommended_LOCATION);
        ...
        CameraUpdate cameraUpdate = CameraUpdateFactory.newLatLngZoom(Recommended_LOCATION, 9);
    ...
    private void showDialogForPermission(String msg) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(RecommendedLocationActivity.this);
        builder.setTitle("알림");
